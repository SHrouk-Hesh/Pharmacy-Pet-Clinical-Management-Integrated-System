...
/***********************************************************Skin*********************************************************************************/
/***.box to hide fixed informative boxes****/
$("body").click(function () {
...
//**************topMenu************************
//(menu to show when on or clicking and hide on exitting)
$(function () {
    var proceedHide = true;
...
(function ($) {
    $(document).ready(function () {
        ...
        $(document).ready(function () {
            ...
            $("#cssmenu").add($(this).find('a')).find("[href='/" + filename + "']").parents("#cssmenu > ul > li").addClass("active");
            ...
            $("title").text(filename.length > 0 ? capitalizeEachWord(filename.split("_").join(" ")) : "Home");
            /****/
    ...
    $("#form").submit(function (e) {
        ...
        $.ajax({
            ...
            success: function () {
                ...
                setTimeout(function () { $("#successbox").hide();  }, 2000);
            }
        })
        e.preventDefault();
    })
